...
local Rayfield = game:GetObjects("rbxassetid://12320623959")[1]
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Icon.ImageTransparency = 1
	...
	wait(0.05)
	TweenService:Create(LoadingFrame.Icon, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0}):Play()
	wait(0.05)
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			Main.Image = "http://www.roblox.com/asset/?id=13235545069"
        ...
        function Tab:CreatePlayerMenu(PlayerSettings)
            local PlayerMenu = Elements.Template.PlayerButton:Clone()
			TabPage.UIListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Left
			local img, ready = game.Players:GetUserThumbnailAsync(game.Players:FindFirstChild(PlayerSettings.Username).UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420)
			PlayerMenu.Title.Text = PlayerSettings.Username
			PlayerMenu.Name = PlayerSettings.Username
			PlayerMenu.PFP.Image = img
			PlayerMenu.Visible = true
			PlayerMenu.Parent = TabPage

			PlayerMenu.BackgroundTransparency = 1
			PlayerMenu.UIStroke.Transparency = 1
			PlayerMenu.Title.TextTransparency = 1

			PlayerMenu.Size = UDim2.new(0.5, -50,0, 130)

			TweenService:Create(PlayerMenu, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
			TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			TweenService:Create(PlayerMenu.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()	
			
			if PlayerSettings.Banned then
				PlayerMenu.Ban.Text = "Unban"
			end
			if PlayerSettings.Whitelisted then
				PlayerMenu.Whitelist.Text = "Unwhitelist"
			end
			PlayerMenu.Ban.MouseButton1Click:Connect(function()
				if PlayerMenu.Ban.Text == "Ban" then
					local Success, Response = pcall(function()
						PlayerSettings.BanCallback(PlayerSettings.Username, true)
					end)
					TweenService:Create(PlayerMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
					TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					wait(0.1)
					TweenService:Create(PlayerMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
					PlayerMenu.Ban.Text = "Unban"
				else
					local Success, Response = pcall(function()
						PlayerSettings.BanCallback(PlayerSettings.Username, false)
					end)
					TweenService:Create(PlayerMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
					TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					wait(0.1)
			...
			PlayerMenu.Kick.MouseButton1Click:Connect(function()
				
				local Success, Response = pcall(function()
					PlayerSettings.KickCallback(PlayerSettings.Username)
				end)
				TweenService:Create(PlayerMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
				TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
				wait(0.1)
			...
			PlayerMenu.Whitelist.MouseButton1Click:Connect(function()
				if PlayerMenu.Whitelist.Text == "Whitelist" then
					local Success, Response = pcall(function()
						PlayerSettings.WhitelistCallback(PlayerSettings.Username, true)
					end)
					TweenService:Create(PlayerMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
					TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					wait(0.1)
					...
					local Success, Response = pcall(function()
						PlayerSettings.WhitelistCallback(PlayerSettings.Username, false)
					end)
					TweenService:Create(PlayerMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
					TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					wait(0.1)
					TweenService:Create(PlayerMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(PlayerMenu.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
					PlayerMenu.Whitelist.Text = "Whitelist"
				end


			end)

			PlayerMenu.MouseEnter:Connect(function()
				TweenService:Create(PlayerMenu, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
			end)

			PlayerMenu.MouseLeave:Connect(function()
				TweenService:Create(PlayerMenu, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			end)
		end
		
		function Tab:DestroyPlayer(name)
			if TabPage:FindFirstChild(name) then
				TabPage:FindFirstChild(name):Destroy()
			end
		end
	...
	TweenService:Create(LoadingFrame.Icon, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
